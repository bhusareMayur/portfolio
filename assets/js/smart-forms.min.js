...
})(
  {
    1: [
      function (e, t, n) {
        ...
        function v() {
          y({ status: "success", message: "Your message has been delivered." }),
            l.reset();
        }
        function b(e) {
          var t = "Oops...",
          ...
          o(c, "load", null, function () {
            ...
            10485760 < l.getFileSize()
              ? y({
                  status: "error",
                  message:
                    "Please make sure the total size of attachments is less than 10mb.",
                })
